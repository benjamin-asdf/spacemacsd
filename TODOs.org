...
(defun my/ggtags-eldoc-advice (original-func &rest args)
	(and
	 (not (memq major-mode ggtags-eldoc-disabled-major-modes))
	 (apply original-func args)
	 ))

(advice-add 'ggtags-eldoc-function :around #'my/ggtags-eldoc-advice)
